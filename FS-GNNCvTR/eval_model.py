...
device = "cuda:0"      
model_eval = GNNCvTR_eval(dataset, gnn, support_set, pretrained, baseline, tl)
...
for epoch in range(1, 10000):
    ...
    roc_scores, gnn_model, cnn_model, gnn_opt, cnn_opt = model_eval.meta_evaluate() #FS-GNNCvTR
    ...
    save_result(epoch, N, exp, "results-exp/mean-GIN_tox21_5.txt", tl)
